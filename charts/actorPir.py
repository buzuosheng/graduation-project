...
cur = conn.cursor()
select_sql = "select actors from test"
...
def Pie1():
  ...
  Pie()
  .add("", newdata)
  .set_global_opts(title_opts=opts.TitleOpts(title="Pie-演员"),legend_opts=opts.LegendOpts(pos_left=160))
  .set_series_opts(label_opts=opts.LabelOpts(formatter="{b}: {c}")))
  return pie

Pie1().render('C:\\Users\\1\\Desktop\\actorPie.html')